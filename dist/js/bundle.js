...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nexports.addEntry = undefined;\n\nvar _base = __webpack_require__(/*! ./base */ \"./src/js/views/base.js\");\n\nvar type = document.querySelector('.type-selected'); // NEED:\n// 1. Whenever 'add' button is clicked, update transactions list\n//    - must check if all inputs have a value\n//    - must check if all inputs are valid\n// change type selection function\n\nvar incGreen = '#81B97A';\nvar expRed = '#D76464';\n\n// need to add classes for each types selected state\n\nvar changeType = function changeType(e) {\n  if (e.target.innerHTML === \"+\") {\n    e.target.classList.toggle('inc-selected');\n  } else {\n    e.target.classList.toggle('exp-selected');\n  }\n};\n\nfor (var i = 0; i < _base.elements.typeBtns.length; i++) {\n  _base.elements.typeBtns[i].addEventListener(\"click\", changeType);\n}\n// typeGroup.addEventListener('click', function(e) {\n//   changeType(e);\n// })\n\n// if (elements.type.innerHTML === '+') {\n//   elements.type.style.background = incGreen;\n//   elements.type.style.color = '#FFF';\n// }\n// else {\n//   elements.type.style.background = expRed;\n//   elements.type.style.color = '#FFF';\n// }\n\n\nvar entryHTML = function entryHTML(type, desc, amt) {\n  return '\\n    <div class=\"transactions-list__entry\">\\n      <div class=\"transactions-container__desc\">\\n        <h3>' + desc + '</h3>\\n        <p class=\"entry__type\">' + type + '</p>\\n      </div>\\n      <div class=\"transactions-list__amt\">\\n        <h3>' + type + '$' + amt + '</h3>\\n        <button class=\"transactions-list__remove\">\\n          <i class=\"fa fa-times\"></i>\\n          <p class=\"remove__text\">remove</p>\\n        </button>\\n      </div>\\n    </div>\\n  ';\n};\n\nvar addEntry = exports.addEntry = function addEntry(type, desc, amt) {\n  // return html string\n\n  var transactionsList = _base.elements.transactionsList;\n\n  transactionsList.insertAdjacentHTML('beforeend', entryHTML(type, desc, amt));\n};\n\n//# sourceURL=webpack:///./src/js/views/searchView.js?");
